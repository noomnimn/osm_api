...
const project = require('./controllers/goal')
...
module.exports = function (app) {
    ...
    app.get('/api/v1/requirement/exportdata/:status', requirement.exportData)
    ...
    app.get('/api/v1/archives/findall/:limit/:offset/:text', archives.findAll)
    app.get('/api/v1/archives/findall', archives.findAll)
    app.get('/api/v1/archives/findallpagination/:limit/:offset/:text', archives.findallpagination)
    app.get('/api/v1/archives/getbyId/:id', archives.findArcById)
    app.post('/api/v1/archives', archives.createArc)
    app.delete('/api/v1/archives/:id', archives.deleteArc)
    app.put('/api/v1/archives/:id', archives.updateArc)

   // PLAN
   app.get('/api/v1/project/findall', project.findAll)
   app.get('/api/v1/project/findallpagination/:limit/:offset/:text', project.findallpagination)
   app.get('/api/v1/project/getbyId/:id', project.findById)
   app.post('/api/v1/project', project.createGoal)
   app.delete('/api/v1/project/:id', project.deleteGoal)
   app.put('/api/v1/project/:id', project.updateGoal)
